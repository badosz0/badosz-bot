        ...
        return {
            fields: [
                ...
                },
                {
                    ...
                    text: (server.channels.cache.filter((channel) => channel.type == "voice")
            ...
            thumbnail: server.icon
                ? (server.iconURL() as string)
                : `https://dummyimage.com/128/7289DA/FFFFFF/&text=${encodeURIComponent(server.nameAcronym)}`,
        };
    },
});
